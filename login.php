...
$uid = uniqid('a'); // XML ID cannot start with digit
$file = $_FILES['photo'];
$fileName = $file['name'];
$fileTmpName = $file['tmp_name'];

$fileStoreName = $uid.$fileName;
$fileDestination = 'photo/'.$fileStoreName;
...
// add the user name and photo
$xmlh->setAttribute($user_element, "name", $_POST["name"]);
$xmlh->setAttribute($user_element, "id", $uid);
$xmlh->setAttribute($user_element, "photo", $fileDestination);
