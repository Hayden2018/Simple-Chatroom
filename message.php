...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        function showMessage(nameStr, contentStr, color) {  
            ...
            let conetentNode = document.createElementNS("http://www.w3.org/2000/svg", "tspan");
            let urlRegex = /(https?:\/\/[^\s]+)/g;
            contentStr = contentStr.replace(urlRegex, (url) => {
                return `<a target="_blank" style="text-decoration:underline; fill:${color}" href="${url}">${url}</a>`;
            })
    ...
    <svg width="800px" height="500px"
     ...
     xmlns:a="http://www.adobe.com/svg10-extensions" a:timeline="independent">
        ...
        <rect width="600" height="480" style="fill:white;stroke:red;stroke-width:2"/>
        <text x="300" y="40" style="fill:red;font-size:30px;font-weight:bold;text-anchor:middle">Chat Window</text> 
